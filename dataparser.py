...
for i in range(1, 5):
    ...
    characters = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'á', 'é', 'í', 'ó', 'ú', 'ñ', 'à', 'è', 'ò', 'ù', 'ç', 'â', 'ê', 'î', 'ô', 'û', 'ä', 'ë', 'ï', 'ö', 'ü', 'å', 'ø', 'æ', 'č', 'ď', 'ě', 'ň', 'ř', 'š', 'ť', 'ů', 'ž', 'ý', 'ĺ', 'ľ', 'ŕ', 'ą', 'ć', 'ę', 'ł', 'ń', 'ś', 'ź', 'ż', 'ð', 'þ', 'ğ', 'ş', 'ı', 'ã', 'õ', 'ő', 'ű', 'ß']
    sentences = []
